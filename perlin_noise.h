...
private:
    // initialisation of the permutations vector, containing values for random gradients
    ...
    // holds double the number of permutations
    int p[512];

    // functions necessary to compute the Perlin noise
